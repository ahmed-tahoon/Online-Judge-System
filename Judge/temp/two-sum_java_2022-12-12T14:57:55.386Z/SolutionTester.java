...
public class SolutionTester {
    private static final String TESTCASE_FILE = "test-cases.txt";
        ...
        try {
            ...
            try {
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    // String testCase = "Test Two Sum: Input: " + Arrays.toString(nums) + ", " +
                    // target + "; Your answer:" + Arrays.toString(ret) + "; Expected answer: " +
                    ...
                    if (!testResult) {
                        String content = "[Fail]Failed at: Input: " + Arrays.toString(nums) + ", " + target
                                + "; Your answer:" + Arrays.toString(ret) + "; Expected answer: "
                                + Arrays.toString(expected);
                        System.out.println("[Fail]" + Arrays.toString(nums) + ", " + target + ";" + Arrays.toString(ret)
                                + ";" + Arrays.toString(expected));
